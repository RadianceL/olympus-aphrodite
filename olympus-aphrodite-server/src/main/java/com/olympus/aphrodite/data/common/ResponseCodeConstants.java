package com.olympus.aphrodite.data.common;
...
public class ResponseCodeConstants {
    ...
    public static final Boolean STATE_OK_TYPE = Boolean.TRUE;

    public static final Boolean STATE_ERROR_TYPE =  Boolean.FALSE;

    /**
     * 全局异常处理通用
     */
    public static final String GLOBAL_EXCEPTION_COMMON = "1001";
